 ...
 * @generated
 */
public class ComponentModelViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return PrimitiveComponentEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = ComponentModelVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = ComponentModelVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!ComponentModelElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != ComponentModelVisualIDRegistry
								.getNodeVisualID(op.getContainerView(),
										domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!PrimitiveComponentEditPart.MODEL_ID
						.equals(ComponentModelVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return InPortEditPart.VISUAL_ID == visualID
				|| OutPortEditPart.VISUAL_ID == visualID
				|| NumericPropertyEditPart.VISUAL_ID == visualID
				|| EnumPropertyEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = ComponentModelVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(PrimitiveComponentEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = ComponentModelVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case InPortEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (ComponentModelVisualIDRegistry.getVisualID(elementTypeHint)) {
		}
	...
	public Node createInPort_2101(EObject domainElement, View containerView,
		...
		node.setType(ComponentModelVisualIDRegistry
	...
	public Node createNumericProperty_2103(EObject domainElement,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ComponentModelVisualIDRegistry
				.getType(NumericPropertyEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createEnumProperty_2104(EObject domainElement,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ComponentModelVisualIDRegistry
				.getType(EnumPropertyEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	private void stampShortcut(View containerView, Node target) {
		if (!PrimitiveComponentEditPart.MODEL_ID
				.equals(ComponentModelVisualIDRegistry
						.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE
					.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put(
					"modelID", PrimitiveComponentEditPart.MODEL_ID); //$NON-NLS-1$
