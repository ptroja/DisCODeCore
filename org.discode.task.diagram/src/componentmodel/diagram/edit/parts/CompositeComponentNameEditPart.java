 ...
 * @generated
 */
public class CompositeComponentNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public CompositeComponentNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new CompositeComponentEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentModelParserProvider
					.getParser(
							ComponentModelElementTypes.CompositeComponent_2001,
							getParserElement(),
							ComponentModelVisualIDRegistry
									.getType(componentmodel.diagram.edit.parts.CompositeComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
