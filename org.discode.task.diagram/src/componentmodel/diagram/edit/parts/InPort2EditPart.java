...
import componentmodel.diagram.edit.policies.InPort2ItemSemanticEditPolicy;
...
public class InPort2EditPart extends BorderedBorderItemEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof InPortName2EditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof componentmodel.diagram.edit.parts.InPort2EditPart) {
			types.add(ComponentModelElementTypes.InPortDelegatesTo_4002);
		}
