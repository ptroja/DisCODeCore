...
import componentmodel.diagram.edit.policies.InPort3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InPort3EditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public InPort3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InPort3ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new InterfaceInPortFigure();
	}

	/**
	 * @generated
	 */
	public InterfaceInPortFigure getPrimaryShape() {
		return (InterfaceInPortFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof InPortName3EditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof componentmodel.diagram.edit.parts.InPort3EditPart) {
			types.add(ComponentModelElementTypes.InPortDelegatesTo_4002);
		}
		return types;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == ComponentModelElementTypes.InPortDelegatesTo_4002) {
