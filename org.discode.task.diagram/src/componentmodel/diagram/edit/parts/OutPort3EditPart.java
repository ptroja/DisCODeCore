...
import componentmodel.diagram.edit.policies.OutPort3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OutPort3EditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public OutPort3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OutPort3ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof OutPortName3EditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof componentmodel.diagram.edit.parts.OutPort3EditPart) {
			types.add(ComponentModelElementTypes.OutPortPropagatesTo_4005);
		}
