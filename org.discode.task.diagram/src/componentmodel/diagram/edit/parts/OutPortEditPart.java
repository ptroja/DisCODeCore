...
import componentmodel.diagram.edit.policies.OutPortItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OutPortEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void refreshBounds() {
		Dimension size = super.getMainFigure().getPreferredSize();
	 ...
	 * @generated
	 */
	public OutPortEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OutPortItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new OutPortFigure();
	}

	/**
	 * @generated
	 */
	public OutPortFigure getPrimaryShape() {
		return (OutPortFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof OutPortNameEditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof componentmodel.diagram.edit.parts.OutPortEditPart) {
			types.add(ComponentModelElementTypes.OutPortPropagatesTo_4005);
		}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == ComponentModelElementTypes.OutPortPropagatesTo_4005) {
		...
		} else if (relationshipType == ComponentModelElementTypes.OutPortSink_4004) {
	 ...
	 * @generated
	 */
	public class OutPortFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		public OutPortFigure() {
