 ...
 * @generated
 */
public class PrimitiveComponentNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PrimitiveComponentNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentModelParserProvider
					.getParser(
							ComponentModelElementTypes.PrimitiveComponent_2002,
							getParserElement(),
							ComponentModelVisualIDRegistry
									.getType(componentmodel.diagram.edit.parts.PrimitiveComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
