...
import componentmodel.diagram.part.ComponentModelDiagramEditorUtil;
import componentmodel.diagram.part.Messages;

/**
 * @generated
 */
public class OpenPrimitiveDiagramEditPolicy extends OpenEditPolicy {
	...
	private static class OpenDiagramCommand extends
							...
							for (Iterator it = diagramFacet.eResource()
								...
								if (nextResource.isLoaded()
										&& !getEditingDomain().isReadOnly(
												nextResource)) {
									nextResource
											.save(ComponentModelDiagramEditorUtil
													.getSaveOptions());
								}
							}
		...
		protected String getDiagramKind() {
			return "PrimitiveComponentModel";
		}
		...
		protected String getEditorID() {
			return "primitivecomponentmodel.diagram.part.ComponentModelDiagramEditorID";
		}
	}
