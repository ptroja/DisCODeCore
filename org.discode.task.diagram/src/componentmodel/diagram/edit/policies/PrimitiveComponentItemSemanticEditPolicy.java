...
import componentmodel.diagram.edit.commands.InPort3CreateCommand;
import componentmodel.diagram.edit.commands.OutPort2CreateCommand;
import componentmodel.diagram.edit.commands.OutPort3CreateCommand;
...
public class PrimitiveComponentItemSemanticEditPolicy extends
	...
	public PrimitiveComponentItemSemanticEditPolicy() {
		super(ComponentModelElementTypes.PrimitiveComponent_2002);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (ComponentModelElementTypes.InPort_3003 == req.getElementType()) {
			return getGEFWrapper(new InPort3CreateCommand(req));
		}
		if (ComponentModelElementTypes.OutPort_3004 == req.getElementType()) {
			return getGEFWrapper(new OutPort3CreateCommand(req));
		}
