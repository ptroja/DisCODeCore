 ...
 * @generated
 */
public abstract class ComponentModelAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = ComponentModelDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected ComponentModelAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
