 ...
 * @generated
 */
public class ComponentModelDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ComponentModelDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof ComponentModelDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((ComponentModelDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ComponentModelDomainNavigatorItem(
