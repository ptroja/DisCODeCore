 ...
 * @generated
 */
public class ComponentModelInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new ComponentModelNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				CompositeComponentEditPart.MODEL_ID));
		ComponentModelDiagramEditorUtil.runWizard(getShell(), wizard,
