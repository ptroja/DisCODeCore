...
/**
 * This is the item provider adapter for a {@link componentmodel.CompositeComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeComponentItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ComponentmodelPackage.Literals.COMPOSITE_COMPONENT__COMPONENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CompositeComponent.class)) {
			case ComponentmodelPackage.COMPOSITE_COMPONENT__COMPONENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ComponentmodelPackage.Literals.COMPOSITE_COMPONENT__COMPONENTS,
				 ComponentmodelFactory.eINSTANCE.createPrimitiveComponent()));

		newChildDescriptors.add
			(createChildParameter
				(ComponentmodelPackage.Literals.COMPOSITE_COMPONENT__COMPONENTS,
				 ComponentmodelFactory.eINSTANCE.createCompositeComponent()));
	}
